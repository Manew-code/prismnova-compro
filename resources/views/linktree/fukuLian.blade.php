...
<body>
    ...
    <img src="{{ asset('assets/logo-character/Fuku_Lian_Pose1.png') }}" alt="Character" class="character-img" id="character">
    <div class="chat-balloon" id="chatBalloon">
        Hello! I'm Fuku Lian. Welcome to my Linktree!
    </div>
    <div class="click-me" id="clickMe">Click me!</div>
    <div class="container">
        <img src="{{ asset('assets/logo-character/LOGO_LIAN_2.png') }}" alt="Logo" class="logo">
        <div class="card">
            <a href="https://facebook.com/FukuLian" class="card-body text-decoration-none text-dark" target="_blank">
                <i class="fab fa-facebook-f card-icon text-primary"></i>
                <h5 class="card-title">Facebook</h5>
            </a>
        </div>
        <div class="card">
            <a href="https://x.com/FukuLian" class="card-body text-decoration-none text-dark" target="_blank">
                <i class="fab fa-twitter card-icon text-info"></i>
                <h5 class="card-title">Twitter</h5>
            </a>
        </div>
        <div class="card">
            <a href="https://instagram.com/FukuLian" class="card-body text-decoration-none text-dark" target="_blank">
                <i class="fab fa-instagram card-icon text-danger"></i>
                <h5 class="card-title">Instagram</h5>
            </a>
        </div>
        <div class="card">
            <a href="https://youtube.com/@fukulian" class="card-body text-decoration-none text-dark" target="_blank">
                <i class="fab fa-youtube card-icon text-danger"></i>
                <h5 class="card-title">YouTube</h5>
            </a>
        </div>
        <div class="card">
            <a href="https://tiktok.com/@fukulian" class="card-body text-decoration-none text-dark" target="_blank">
    ...
    <script>
        $(document).ready(function() {
            ...
            const messages = [
                "Hello! Aku Fuku Lian!",
                "Apa? kerang? tentu saja aku punya banyak!! mau liat yang bentuknya kaya gimana? beragam loh bentuknya!",
            ];
